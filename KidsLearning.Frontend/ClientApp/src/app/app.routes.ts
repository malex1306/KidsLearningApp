...
export const routes: Routes = [
  ...
  {
    path: 'learning-letter-tasks/:subject/:id/child/:childId/:exam',
    component: LearningLetterTasks,
    canActivate: [authGuard]
  },
  {
    path: 'learning-task-english/:subject/:id/child/:childId/:exam',
    component: LearningTaskEnglish,
    canActivate: [authGuard]
  },
