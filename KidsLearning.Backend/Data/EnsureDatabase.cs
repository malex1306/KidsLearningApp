        ...
        if (!context.Questions.Any())
        {
            var questions = new List<Questions>
            {
               ...
               // 3. Klasse - Formen erkennen (LearningTask 3)
                ...
                new Questions { Text = "Die Kuh macht ___.", CorrectAnswer = "Muh", Options = new List<string> { "Wuff", "Miau", "Muh" }, LearningTaskId = 10 },
                new Questions { Text = "Der Himmel ist ___.", CorrectAnswer = "blau", Options = new List<string> { "rot", "blau", "grün" }, LearningTaskId = 10 },
                new Questions { Text = "Die Banane ist ___.", CorrectAnswer = "gelb", Options = new List<string> { "gelb", "blau", "lila" }, LearningTaskId = 10 },
                new Questions { Text = "Ein Auto fährt auf der ___.", CorrectAnswer = "Straße", Options = new List<string> { "Straße", "Wiese", "Wald" }, LearningTaskId = 10 },
                new Questions { Text = "Der Ball ist ___.", CorrectAnswer = "rund", Options = new List<string> { "eckig", "rund", "flach" }, LearningTaskId = 10 },
                new Questions { Text = "Ein Fisch schwimmt im ___.", CorrectAnswer = "Wasser", Options = new List<string> { "Sand", "Wasser", "Baum" }, LearningTaskId = 10 },
                new Questions { Text = "Die Sonne ist ___.", CorrectAnswer = "warm", Options = new List<string> { "warm", "kalt", "nass" }, LearningTaskId = 10 },
                new Questions { Text = "Die Katze macht ___.", CorrectAnswer = "Miau", Options = new List<string> { "Miau", "Wuff", "Muh" }, LearningTaskId = 10 },
                new Questions { Text = "Wir essen ein ___.", CorrectAnswer = "Brot", Options = new List<string> { "Brot", "Auto", "Haus" }, LearningTaskId = 10 },
                new Questions { Text = "Das Baby liegt im ___.", CorrectAnswer = "Bett", Options = new List<string> { "Bett", "Auto", "Baum" }, LearningTaskId = 10 },

                // Fragen für "Fülle die Lücken" (LearningTask 10 - 1. Klasse)
                new Questions { Text = "Die Blume ist ___.", CorrectAnswer = "schön", Options = new List<string> { "schnell", "schön", "laut" }, LearningTaskId = 10 },
                new Questions { Text = "Der Vogel fliegt in den ___.", CorrectAnswer = "Himmel", Options = new List<string> { "Himmel", "Boden", "Baum" }, LearningTaskId = 10 },
                new Questions { Text = "Der Junge isst ein ___.", CorrectAnswer = "Eis", Options = new List<string> { "Auto", "Eis", "Ball" }, LearningTaskId = 10 },
                new Questions { Text = "Die Oma liest ein ___.", CorrectAnswer = "Buch", Options = new List<string> { "Buch", "Auto", "Apfel" }, LearningTaskId = 10 },
                new Questions { Text = "Das Haus hat ein ___.", CorrectAnswer = "Dach", Options = new List<string> { "Dach", "Bein", "Rad" }, LearningTaskId = 10 },
                new Questions { Text = "Der Hund frisst einen ___.", CorrectAnswer = "Knochen", Options = new List<string> { "Knochen", "Ball", "Schuh" }, LearningTaskId = 10 },
                new Questions { Text = "Die Ente schwimmt im ___.", CorrectAnswer = "Teich", Options = new List<string> { "Teich", "Haus", "Wald" }, LearningTaskId = 10 },
                new Questions { Text = "Das Feuer ist ___.", CorrectAnswer = "heiß", Options = new List<string> { "heiß", "kalt", "nass" }, LearningTaskId = 10 },
                new Questions { Text = "Der Lehrer schreibt an die ___.", CorrectAnswer = "Tafel", Options = new List<string> { "Tafel", "Wand", "Tür" }, LearningTaskId = 10 },
                new Questions { Text = "Die Uhr zeigt die ___.", CorrectAnswer = "Zeit", Options = new List<string> { "Zeit", "Hand", "Nase" }, LearningTaskId = 10 },

                // Fragen für "Fülle die Lücken" (LearningTask 10 - 2. Klasse)
                new Questions { Text = "Der Regen fällt vom ___.", CorrectAnswer = "Himmel", Options = new List<string> { "Himmel", "Boden", "Baum" }, LearningTaskId = 10 },
                new Questions { Text = "Die Maus läuft ins ___.", CorrectAnswer = "Loch", Options = new List<string> { "Loch", "Haus", "Glas" }, LearningTaskId = 10 },
                new Questions { Text = "Im Winter fällt der ___.", CorrectAnswer = "Schnee", Options = new List<string> { "Regen", "Schnee", "Wind" }, LearningTaskId = 10 },
                new Questions { Text = "Der Schüler schreibt mit einem ___.", CorrectAnswer = "Stift", Options = new List<string> { "Stift", "Rad", "Glas" }, LearningTaskId = 10 },
                new Questions { Text = "Am Abend wird es ___.", CorrectAnswer = "dunkel", Options = new List<string> { "hell", "dunkel", "laut" }, LearningTaskId = 10 },
                new Questions { Text = "Der Tisch hat vier ___.", CorrectAnswer = "Beine", Options = new List<string> { "Beine", "Arme", "Türen" }, LearningTaskId = 10 },
                new Questions { Text = "Ein Jahr hat zwölf ___.", CorrectAnswer = "Monate", Options = new List<string> { "Monate", "Tage", "Stunden" }, LearningTaskId = 10 },
                new Questions { Text = "Ein Apfelbaum hat viele ___.", CorrectAnswer = "Äpfel", Options = new List<string> { "Äpfel", "Autos", "Tiere" }, LearningTaskId = 10 },
                new Questions { Text = "Die Kerze gibt ___.", CorrectAnswer = "Licht", Options = new List<string> { "Licht", "Luft", "Lärm" }, LearningTaskId = 10 },
                new Questions { Text = "Der König trägt eine ___.", CorrectAnswer = "Krone", Options = new List<string> { "Krone", "Jacke", "Uhr" }, LearningTaskId = 10 },

                // Fragen für "Fülle die Lücken" (LearningTask 10 - 3. Klasse)
                new Questions { Text = "Die Erde dreht sich um die ___.", CorrectAnswer = "Sonne", Options = new List<string> { "Sonne", "Mond", "Sterne" }, LearningTaskId = 10 },
                new Questions { Text = "Ein Rechteck hat vier ___.", CorrectAnswer = "Ecken", Options = new List<string> { "Ecken", "Seiten", "Räder" }, LearningTaskId = 10 },
                new Questions { Text = "Der Fluss fließt ins ___.", CorrectAnswer = "Meer", Options = new List<string> { "Meer", "Gebirge", "Haus" }, LearningTaskId = 10 },
                new Questions { Text = "Ein Jahr hat 365 ___.", CorrectAnswer = "Tage", Options = new List<string> { "Tage", "Stunden", "Wochen" }, LearningTaskId = 10 },
                new Questions { Text = "Das Gegenteil von heiß ist ___.", CorrectAnswer = "kalt", Options = new List<string> { "warm", "kalt", "schön" }, LearningTaskId = 10 },
                new Questions { Text = "Die Hauptstadt von Deutschland ist ___.", CorrectAnswer = "Berlin", Options = new List<string> { "Berlin", "Hamburg", "Köln" }, LearningTaskId = 10 },
                new Questions { Text = "Die Ampel zeigt ___.", CorrectAnswer = "Farben", Options = new List<string> { "Farben", "Lichter", "Töne" }, LearningTaskId = 10 },
                new Questions { Text = "Das Gegenteil von laut ist ___.", CorrectAnswer = "leise", Options = new List<string> { "leise", "ruhig", "schnell" }, LearningTaskId = 10 },
                new Questions { Text = "Der Bäcker backt ___.", CorrectAnswer = "Brot", Options = new List<string> { "Brot", "Milch", "Tische" }, LearningTaskId = 10 },
                new Questions { Text = "Das Thermometer misst die ___.", CorrectAnswer = "Temperatur", Options = new List<string> { "Temperatur", "Zeit", "Höhe" }, LearningTaskId = 10 },

                // Fragen für "Fülle die Lücken" (LearningTask 10 - 4. Klasse)
                new Questions { Text = "Die Hauptstadt von Frankreich ist ___.", CorrectAnswer = "Paris", Options = new List<string> { "Paris", "Rom", "Berlin" }, LearningTaskId = 10 },
                new Questions { Text = "Wasser gefriert bei ___.", CorrectAnswer = "0 Grad", Options = new List<string> { "0 Grad", "10 Grad", "100 Grad" }, LearningTaskId = 10 },
                new Questions { Text = "Das größte Land der Erde ist ___.", CorrectAnswer = "Russland", Options = new List<string> { "Russland", "China", "Kanada" }, LearningTaskId = 10 },
                new Questions { Text = "Das Gegenteil von schwer ist ___.", CorrectAnswer = "leicht", Options = new List<string> { "leicht", "dick", "stark" }, LearningTaskId = 10 },
                new Questions { Text = "Die Donau ist ein ___.", CorrectAnswer = "Fluss", Options = new List<string> { "Fluss", "Gebirge", "See" }, LearningTaskId = 10 },
                new Questions { Text = "Die Erde ist ein ___.", CorrectAnswer = "Planet", Options = new List<string> { "Planet", "Stern", "Mond" }, LearningTaskId = 10 },
                new Questions { Text = "Das Gegenteil von früh ist ___.", CorrectAnswer = "spät", Options = new List<string> { "spät", "schnell", "klein" }, LearningTaskId = 10 },
                new Questions { Text = "Die Alpen sind ein ___.", CorrectAnswer = "Gebirge", Options = new List<string> { "Gebirge", "Fluss", "Meer" }, LearningTaskId = 10 },
                new Questions { Text = "Das Blut ist ___.", CorrectAnswer = "rot", Options = new List<string> { "rot", "blau", "grün" }, LearningTaskId = 10 },
                new Questions { Text = "Der höchste Berg der Erde ist der ___.", CorrectAnswer = "Mount Everest", Options = new List<string> { "Mount Everest", "Zugspitze", "Matterhorn" }, LearningTaskId = 10 },
